...
const Array = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 rounded-lg">
      <h1 className="text-3xl font-bold text-purple-600 mb-4">Arrays in DSA</h1>
      ...
      <h2 className="text-2xl font-semibold text-gray-800 mb-2">Declaration and Initialization</h2>
...
int[] nums = {1, 2, 3, 4, 5}; // Initialization`}</code>
      ...
      <h2 className="text-2xl font-semibold text-gray-800 mb-2">Accessing Elements</h2>
      <pre className="bg-gray-100 text-sm p-4 rounded mb-4 overflow-x-auto">
        <code>{`System.out.println(nums[0]); // Output: 1`}</code>
      </pre>

      <h2 className="text-2xl font-semibold text-gray-800 mb-2">Common Operations</h2>
      ...
      <h2 className="text-2xl font-semibold text-gray-800 mb-2">Example: Find Max Element</h2>
      <pre className="bg-gray-100 text-sm p-4 rounded mb-4 overflow-x-auto">
        <code>{`int max = nums[0];
