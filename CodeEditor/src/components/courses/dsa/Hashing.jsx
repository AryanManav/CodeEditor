...
const Hashing = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 rounded-lg">
      <h1 className="text-3xl font-bold text-purple-600 mb-4">Hashing in DSA</h1>
      ...
      <h2 className="text-2xl font-semibold text-gray-800 mb-2">HashMap in Java</h2>
...
System.out.println(map.get("apple")); // Output: 2`}</code>
      ...
      <h2 className="text-2xl font-semibold text-gray-800 mb-2">Common Use Cases</h2>
      ...
      <h2 className="text-2xl font-semibold text-gray-800 mb-2">Example: Frequency Count</h2>
      <pre className="bg-gray-100 text-sm p-4 rounded mb-4 overflow-x-auto">
