...
const CSS = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 rounded-lg">
      <h1 className="text-3xl font-bold text-purple-700 mb-4">CSS Tutorial</h1>
...
h1 {
  ...
  text-align: center;
      ...
      <h2 className="text-xl font-semibold text-purple-600 mt-6 mb-2">Selectors</h2>
      ...
      <h2 className="text-xl font-semibold text-purple-600 mt-6 mb-2">Common Properties</h2>
      <ul className="list-disc list-inside text-gray-700 space-y-1">
