...
function JavaMain() {
  const navItems = [
    ...
    { to: 'oops/classes-and-objects', label: 'Classes & Objects' },
    { to: 'oops/inheritance', label: 'Inheritance' },
  ];

  return (
    <div className="flex flex-col md:flex-row min-h-screen">

      {/* Sidebar (Vertical on md+, Horizontal scrollable on mobile) */}
      <aside className="w-full md:w-64 bg-white border-b md:border-b-0 md:border-r border-gray-200 shadow-md">
        <div className="p-4 md:pb-0">
          <h2 className="text-lg md:text-xl font-bold text-purple-600 mb-2 md:mb-4">Java Tutorial</h2>
        </div>
