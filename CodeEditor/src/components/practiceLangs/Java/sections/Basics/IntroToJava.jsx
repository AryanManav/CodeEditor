...
const IntroToJava = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-6 text-gray-800 dark:text-gray-100">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">Key Features of Java</h2>
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">Hello World Program</h2>
      <p className="mb-2">
        Here's the basic structure of a Java program:
      </p>
...
{`public class HelloWorld {
  public static void main(String[] args) {
    System.out.println("Hello, World!");
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">Java Development Tools</h2>
