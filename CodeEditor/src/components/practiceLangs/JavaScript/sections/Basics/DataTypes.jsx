...
const DataTypes = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 rounded-lg">
      <h1 className="text-3xl font-bold text-purple-600 mb-4">JavaScript Data Types</h1>
      ...
      <h2 className="text-2xl font-semibold text-gray-800 mb-2">Primitive Types:</h2>
      <ul className="list-disc list-inside text-gray-800 mb-4 space-y-1">
        <li><strong>Number</strong> – Integer or floating point (e.g., <code>5, 3.14</code>)</li>
      ...
      <h2 className="text-2xl font-semibold text-gray-800 mb-2">Non-Primitive Types:</h2>
      <ul className="list-disc list-inside text-gray-800 mb-4 space-y-1">
